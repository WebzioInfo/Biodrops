...
export default function BQMSSection() {
  return (
    <section id="bqms" className="relative w-full py-18  bg-[#FFFFFF] text-[#070D0E] overflow-hidden flex flex-col items-center justify-center">
      ...
      >
        ...
        <div className="relative flex flex-col items-start text-left w-full z-10">
          ...
          >
            <Link
              href="/bqms"
              className="group flex items-center justify-center gap-2 px-[14px] py-[14px] bg-[#cfef00] hover:bg-[#c4e201] text-black text-[16px] font-bold uppercase tracking-[0.2em] rounded-full transition-all duration-200 transform active:scale-95 shadow-[0_8px_25px_rgba(207,239,0,0.3)] hover:shadow-[0_12px_35px_rgba(207,239,0,0.5)] min-w-[260px] sm:min-w-[340px] text-center"
            >
              <span>Explore BQMS</span>
              <svg
                ...
                stroke="currentColor"
                strokeWidth={2.5}
                className="w-[20px] h-[20px] text-black transition-transform duration-300 ease-in-out group-hover:translate-y-[3px]"
              >
